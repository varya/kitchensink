...
(function(cordova) {
   ...
   *
   * NOTE: Trying to limit graph requests causes a crash with the current plugin version.
   */
  ...
  /*
   * Trying to show a dialog causes the app to crash with the current plugin version,
   * so the function is disabled.
   * 
